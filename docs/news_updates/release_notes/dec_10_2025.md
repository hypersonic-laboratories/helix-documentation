...
A new version of Creator Kit (v20151210) is being released this time alongside the client build. Please ensure to download it from [the Creator Kit Installation tutorial](https://development.helix-documentation.pages.dev/tutorials/creatorkit/) as usual.
...
- Reduced the time it takes to enter and exit vehicles, making the process feel more responsive.
...
- Character Creator template assets overall
    - Provided multiple asset types to export for wearable creation guidance e.g. body meshes, as well as material examples so copies can simply be made and customized for creators use case.
    - SKM's also provided so setup can be used as a base for custom assets.
...
- Character Creator-related tutorials for Creator Kit:
    - [Body tattoo](https://development.helix-documentation.pages.dev/tutorials/custom_CC_bodyTattoo/).
    - [Face Tattoo](https://development.helix-documentation.pages.dev/tutorials/custom_cc_FaceTattoo/).
    - [Hair](https://development.helix-documentation.pages.dev/tutorials/custom_CC_Hair/).
    - [Shoes](https://development.helix-documentation.pages.dev/tutorials/custom_cc_Shoes/).
- Custom Assets tutorial updates for Creator Kit:
    - Updated custom character mesh tutorial in [Custom Characters](https://development.helix-documentation.pages.dev/tutorials/custom_characters/) with:
    ...
    - Updated custom wearable tutorial in [Custom CC Assets](https://development.helix-documentation.pages.dev/tutorials/custom_cc_assets/) with source metahuman male/female body & head meshes.
    - Updated [Custom Map tutorial](https://development.helix-documentation.pages.dev/tutorials/custom_maps/) with navigation mesh generation steps.
