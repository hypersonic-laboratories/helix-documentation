...
The new Mutable-based Character Creator we announced last release has seen extensive work this cycle, it's where most of this release's effort went. You can see the overview of new character creator from [our documentation page](https://docs.helixgame.com/tutorials/HelixCharacterCreator/cc_overview/).
...
- New **Character Customization API**. We're releasing a new Blueprint/Lua compatible API to query/manipulate clothing slots of characters in runtime within this version. Please check [our documentation](https://docs.helixgame.com/tutorials/HelixCharacterCreator/cc_scripting/) for more details.
