...
The new Mutable-based Character Creator we announced last release has seen extensive work this cycle, it's where most of this release's effort went. For a full overview of the new HELIX Character Creator and its documentation, please refer to the [HELIX Character Creator documentation](https://docs.helixgame.com/tutorials/HelixCharacterCreator/cc_overview/).
