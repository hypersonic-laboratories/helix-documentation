...
Shells are UE5 Level assets that can be spawned in any coordinates (usually underground or in the sky of an existing main map/level). You can teleport players into and out of the shell for a seamless experience.
